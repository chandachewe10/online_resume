...
<body>
    ...
    <center>
        ...
        <div class="card" id="background-img"style="width: 80%; margin-top:50px; padding: 45px; ">
            ...
            <form action={{"employment1/".Auth::user()->id}} method="POST" >
            @csrf
              <!-- Validation Errors -->
          ...
          <x-auth-validation-errors class="mb-4" :errors="$errors" /></p>
                ...
                <input type="text" placeholder="E.g Mopani, StanChart" name="workplace1" style="border:2px solid #ccc; box-sizing:border-box; height: 40px;  border-style: outset; background-color: transparent;" required />
                
                <div style="font-weight: bold; color:navy">What was your role?</div>
                <input type="text" placeholder="E.g Manager, Programmer, IT Col etc" name="role1" style="border:2px solid #ccc; box-sizing:border-box; height: 40px;  border-style: outset; background-color: transparent; " required />

                <div style="font-weight: bold; color:navy">What was your Duties & Functions?</div>
                <textarea name="duties1"  style="border-style: outset;border:4px solid #ccc; background-color: transparent;"></textarea>
                
                
                
                <div style="font-weight: bold; color:navy">Started on</div>
                
                <select name="Daysecond">
...
<br> <br> 
               ...
               <input type="checkbox" name="present1" value="present"> <label for="present" style="color: navy;font-weight: bold; font-size:16px;"> Present</label><br><br>
