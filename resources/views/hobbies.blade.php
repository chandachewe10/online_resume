...
<style>
   #background-img{
        background-image:linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)),url('images/20191112054904-FotoJet32.jpeg');
...
<body>
    ...
    <center>
        ...
        <div class="card" id="background-img"style="width: 80%; margin-top:50px; padding: 45px; ">
            <h3  style="font-weight:bold; color:black">Hobbies</h3>
            <form action={{"hobbies/".Auth::user()->id}} method="POST" >
            @csrf
            <!-- Validation Errors -->
          ...
          <x-auth-validation-errors class="mb-4" :errors="$errors" /></p>
                ...
                <div style="font-weight: bold; color:black">Hobbies</div>
               <textarea name="hobbies"  style="width:80%; height:200px; border-style: outset;border:4px solid #ccc; background-color: transparent;">e.g swimming, cooking, reading novels, playing chess, computer coding etc</textarea>
                <!--Break line--><br>
