...
<style>
   #background-img{
        background-image:linear-gradient(rgba(255,255,255,0.5),rgba(255,255,255,0.5)),url('images/STARP.jpg');
...
<body>
    ...
    <center>
        ...
        <i class="fa fa-user" aria-hidden="true"  style=" font-size:50px; color:grey"></i> 
            <h3  style="font-weight:bold; font-style: italic; color:green">PROFILE</h3>
          ...
          <x-auth-validation-errors class="mb-4" :errors="$errors" /></p>
                ...
                <div style="font-weight: bold; color:green">Profile Summary</div>
               <textarea name="comments"  style="width:90%; height:200px; border-style: outset;border:4px solid #ccc; background-color: transparent;">Write something about your profession</textarea>
                <!--Break line--><br>
