    ...
    <header class="d-print-none">
      <div class="container text-center text-lg-left">
        <div class="py-3 clearfix">
          ...
          <center><h1 style="color:grey">{{Auth::user()->name}}'s Resume</h1></center>
...
<div class="cover shadow-lg bg-white">
  <div class="cover-bg p-3 p-lg-4 text-white">
    <div class="row">
      <div class="col-lg-4 col-md-5">
        <div ><img src="{{asset('storage/'.$languages->image )}}" width="180" height="180" ></div>
      </div>
      <div class="col-lg-8 col-md-7 text-center text-md-start">
        ...
        <div class="d-print-none" data-aos="fade-left" data-aos-delay="200" id="one"  href="#"<a  class="btn btn-light text-dark shadow-sm mt-1 me-1"></a> <a class="btn btn-success shadow-sm mt-1" onclick="window.print()"> Download CV</a></div>
  ...
  <div class="work-experience-section px-3 px-lg-4">
    ...
    <div class="timeline">
      ...
      <div class="timeline-card timeline-card-primary card shadow-sm" id="ones">
        <div class="card-body" >
          <div class="h5 mb-1" >{{$languages->workplace1}} <span class="text-muted h6" id="four">{{$languages->role1}}</span></div>
      ...
      <div class="timeline-card timeline-card-primary card shadow-sm" id="two">
        <div class="card-body" >
          <div class="h5 mb-1">{{$languages->workplace2}} <span class="text-muted h6"  id="three">{{$languages->role2}}</span></div>
