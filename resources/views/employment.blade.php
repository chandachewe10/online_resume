...
<body>
    ...
    <center>
        ...
        <div class="card" id="background-img"style="width: 80%; margin-top:50px; padding: 45px; ">
            <h3  style="font-weight:bold; color:navy">WORK HISTORY</h3>
            <form action={{"employment/".Auth::user()->id}} method="POST" >
            @csrf
              <!-- Validation Errors -->
          ...
          <x-auth-validation-errors class="mb-4" :errors="$errors" /></p>
                ...
                <input type="text" placeholder="E.g Mopani, StanChart" name="workplace" style="border:2px solid #ccc; box-sizing:border-box; height: 40px;  border-style: outset; background-color: transparent; " required />
                <div style="font-weight: bold; color:navy">What was your role?</div>
                <input type="text" placeholder="E.g Manager, Programmer, IT Col etc" name="role" style="border:2px solid #ccc; box-sizing:border-box; height: 40px;  border-style: outset; background-color: transparent; " required />

                <div style="font-weight: bold; color:navy">What was your Duties & Functions?</div>
                <textarea name="duties"  style="border-style: outset;border:4px solid #ccc; background-color: transparent;"></textarea>
               ...
               <select class='Daylast' name="Daylast">
               <option selected>Day</option>
               <option>1</option>
               <option>2</option>
               <option>3</option>
               ...
               <select class="monthlast" name="monthlast">
               <option selected>month</option>
               <option>january</option>
               <option>February</option>
               <option>March</option>
               ...
               <select class="yearlast" name="yearlast">
               <option selected>Year</option>
               <option>2021</option>
               <option>2020</option>
               <option>2019</option>
...
<br> <br> 
               ...
               <input type="checkbox" name="present" value="present"> <label for="present" style="color: navy;font-weight: bold; font-size:16px;"> Present</label><br><br>
...
$(document).ready(function(){
    $("input[type='checkbox']").click(function(){
        if($(this).prop('checked')==true){
         $('.Daylast, .monthlast,.yearlast').val('');
        }
